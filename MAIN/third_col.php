 ...
 <div class="third_col"><!--start of even document post-->
  <?php echo "submitted post goes here";
	...
	if($_SESSION['u_id']==$row_document_clap['u_id'])
	   echo "<a href=\"clap.php?u_id="."$_SESSION[u_id]"."&d_id=$row[d_id]&ope=clapped&like=$row[like]&type=document"."\" target=\"_blank\">Clapped</a>";
	else
	   echo "<a href=\"clap.php?u_id="."$_SESSION[u_id]"."&d_id=$row[d_id]&ope=clap&like=$row[like]&type=document"."\" target=\"_blank\">Clap</a>";
	 echo "+".$row['like'];  
	//delete script
	$disable="";
	if($_SESSION['u_id']==$row['u_id'])
	   echo "<a href=\"delete.php?u_id="."$_SESSION[u_id]"."&d_id=$row[d_id]&ope=delete&type=document"."\" target=\"_blank\">Delete</a>";
	?>
